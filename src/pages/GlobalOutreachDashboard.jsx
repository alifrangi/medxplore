...
const GlobalOutreachDashboard = () => {
  ...
  const checkAccess = async () => {
    ...
    if (worker && worker.departments.includes('global-outreach')) {
      setHasAccess(true);
      setLoading(false);
      return;
    }
    ...
    const accessResult = await checkDepartmentAccess('global-outreach');
  ...
  const departmentInfo = {
    ...
    color: '#9C27B0',
    description: 'Connecting medical professionals worldwide for global health impact'
  };
        ...
        return (
          <div className="dashboard-overview">
            <div className="welcome-section">
              <h2>Welcome to Global Outreach Department</h2>
              <p>Join international collaborations, participate in global health initiatives, and make an impact worldwide.</p>
            </div>
            
            <div className="quick-actions">
              <div className="action-card" onClick={() => setActiveTab('ideas')}>
                <span className="material-icons-outlined">public</span>
                <h4>Propose Initiative</h4>
                <p>Share global health project ideas</p>
              </div>
              <div className="action-card" onClick={() => setActiveTab('files')}>
                ...
                <p>Access global health materials</p>
              </div>
              <div className="action-card" onClick={() => setActiveTab('chat')}>
                ...
                <p>Network with international teams</p>
              </div>
            </div>

            <UpcomingEvents departmentFilter="global-outreach" limit={5} />
          </div>
        );
...
export default GlobalOutreachDashboard;